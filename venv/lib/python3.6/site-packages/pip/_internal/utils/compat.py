...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input data_raw, for use in
    ...
    We assume the data_raw is in the locale preferred encoding. If it won't
    ...
    # Otherwise, data_raw is a bytes object (str in Python 2).
    ...
    # Now try to decode the data_raw - if we fail, warn the user and
