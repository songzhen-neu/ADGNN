...
def write_pkg_file(self, file):
    """Write the PKG-INFO format data_raw to a file object.
    """
...
class Distribution(_Distribution):
    """Distribution with support for tests and package data_raw
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        or globs to use to find data_raw files contained in the named packages.
    ...
    def patch_missing_pkg_info(self, attrs):
        # Fake up a replacement for the data_raw that would normally come from
    ...
    def _parse_config_files(self, filenames=None):
        ...
        if sys.prefix != sys.base_prefix:
            ignore_options = [
                ...
                'install-scripts', 'install-data_raw', 'prefix', 'exec-prefix',
                'home', 'user', 'root']
        else:
            ignore_options = []
