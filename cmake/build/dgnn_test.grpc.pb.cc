...
static const char* DgnnProtoService_method_names[] = {
  ...
  "/dgnn_test.DgnnProtoService/setM",
};
...
DgnnProtoService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_setM_(DgnnProtoService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status DgnnProtoService::Stub::setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::dgnn_test::MMessageForAD* response) {
  return ::grpc::internal::BlockingUnaryCall< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_setM_, context, request, response);
}

void DgnnProtoService::Stub::async::setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_setM_, context, request, response, std::move(f));
}

void DgnnProtoService::Stub::async::setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_setM_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>* DgnnProtoService::Stub::PrepareAsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_setM_, context, request);
}

::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>* DgnnProtoService::Stub::AsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncsetMRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
DgnnProtoService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      DgnnProtoService_method_names[14],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DgnnProtoService::Service, ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](DgnnProtoService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::dgnn_test::MMessageForAD* req,
             ::dgnn_test::MMessageForAD* resp) {
               return service->setM(ctx, req, resp);
             }, this)));
}
...
::grpc::Status DgnnProtoService::Service::setM(::grpc::ServerContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
