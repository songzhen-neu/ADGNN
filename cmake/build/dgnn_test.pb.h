...
extern MMessageForADDefaultTypeInternal _MMessageForAD_default_instance_;
...
template<> ::dgnn_test::MMessageForAD* Arena::CreateMaybeMessage<::dgnn_test::MMessageForAD>(Arena*);
...
class EmbGradMessage final :
 ...
 public:
  ...
  // string graph_mode = 9;
  void clear_graph_mode();
  const std::string& graph_mode() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_graph_mode(ArgT0&& arg0, ArgT... args);
  std::string* mutable_graph_mode();
  PROTOBUF_NODISCARD std::string* release_graph_mode();
  void set_allocated_graph_mode(std::string* graph_mode);
  private:
  const std::string& _internal_graph_mode() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_graph_mode(const std::string& value);
  std::string* _internal_mutable_graph_mode();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr graph_mode_;
  int32_t layerid_;
  int32_t workerid_;
  int32_t epoch_;
  int32_t featsize_;
...
class MMessageForAD final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:dgnn_test.MMessageForAD) */ {
 public:
  inline MMessageForAD() : MMessageForAD(nullptr) {}
  ~MMessageForAD() override;
  explicit constexpr MMessageForAD(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  MMessageForAD(const MMessageForAD& from);
  MMessageForAD(MMessageForAD&& from) noexcept
    : MMessageForAD() {
    *this = ::std::move(from);
  }

  inline MMessageForAD& operator=(const MMessageForAD& from) {
    CopyFrom(from);
    return *this;
  }
  inline MMessageForAD& operator=(MMessageForAD&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const MMessageForAD& default_instance() {
    return *internal_default_instance();
  }
  static inline const MMessageForAD* internal_default_instance() {
    return reinterpret_cast<const MMessageForAD*>(
               &_MMessageForAD_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    17;

  friend void swap(MMessageForAD& a, MMessageForAD& b) {
    a.Swap(&b);
  }
  inline void Swap(MMessageForAD* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(MMessageForAD* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  MMessageForAD* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MMessageForAD>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const MMessageForAD& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const MMessageForAD& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MMessageForAD* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "dgnn_test.MMessageForAD";
  }
  protected:
  explicit MMessageForAD(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // int32 m_benefit = 3;
  void clear_m_benefit();
  int32_t m_benefit() const;
  void set_m_benefit(int32_t value);
  private:
  int32_t _internal_m_benefit() const;
  void _internal_set_m_benefit(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:dgnn_test.MMessageForAD)
 private:
  class _Internal;
...
// string graph_mode = 9;
inline void EmbGradMessage::clear_graph_mode() {
  graph_mode_.ClearToEmpty();
}
inline const std::string& EmbGradMessage::graph_mode() const {
  // @@protoc_insertion_point(field_get:dgnn_test.EmbGradMessage.graph_mode)
  return _internal_graph_mode();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EmbGradMessage::set_graph_mode(ArgT0&& arg0, ArgT... args) {
 
 graph_mode_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:dgnn_test.EmbGradMessage.graph_mode)
}
inline std::string* EmbGradMessage::mutable_graph_mode() {
  std::string* _s = _internal_mutable_graph_mode();
  // @@protoc_insertion_point(field_mutable:dgnn_test.EmbGradMessage.graph_mode)
  return _s;
}
inline const std::string& EmbGradMessage::_internal_graph_mode() const {
  return graph_mode_.Get();
}
inline void EmbGradMessage::_internal_set_graph_mode(const std::string& value) {
  
  graph_mode_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* EmbGradMessage::_internal_mutable_graph_mode() {
  
  return graph_mode_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* EmbGradMessage::release_graph_mode() {
  // @@protoc_insertion_point(field_release:dgnn_test.EmbGradMessage.graph_mode)
  return graph_mode_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void EmbGradMessage::set_allocated_graph_mode(std::string* graph_mode) {
  if (graph_mode != nullptr) {
    
  } else {
    
  }
  graph_mode_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), graph_mode,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (graph_mode_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    graph_mode_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:dgnn_test.EmbGradMessage.graph_mode)
}
...
// int32 wid = 1;
inline void MMessageForAD::clear_wid() {
  wid_ = 0;
}
inline int32_t MMessageForAD::_internal_wid() const {
  return wid_;
}
inline int32_t MMessageForAD::wid() const {
  // @@protoc_insertion_point(field_get:dgnn_test.MMessageForAD.wid)
  return _internal_wid();
}
inline void MMessageForAD::_internal_set_wid(int32_t value) {
  
  wid_ = value;
}
inline void MMessageForAD::set_wid(int32_t value) {
  _internal_set_wid(value);
  // @@protoc_insertion_point(field_set:dgnn_test.MMessageForAD.wid)
}

// int32 m = 2;
inline void MMessageForAD::clear_m() {
  m_ = 0;
}
inline int32_t MMessageForAD::_internal_m() const {
  return m_;
}
inline int32_t MMessageForAD::m() const {
  // @@protoc_insertion_point(field_get:dgnn_test.MMessageForAD.m)
  return _internal_m();
}
inline void MMessageForAD::_internal_set_m(int32_t value) {
  
  m_ = value;
}
inline void MMessageForAD::set_m(int32_t value) {
  _internal_set_m(value);
  // @@protoc_insertion_point(field_set:dgnn_test.MMessageForAD.m)
}

// int32 m_benefit = 3;
inline void MMessageForAD::clear_m_benefit() {
  m_benefit_ = 0;
}
inline int32_t MMessageForAD::_internal_m_benefit() const {
  return m_benefit_;
}
inline int32_t MMessageForAD::m_benefit() const {
  // @@protoc_insertion_point(field_get:dgnn_test.MMessageForAD.m_benefit)
  return _internal_m_benefit();
}
inline void MMessageForAD::_internal_set_m_benefit(int32_t value) {
  
  m_benefit_ = value;
}
inline void MMessageForAD::set_m_benefit(int32_t value) {
  _internal_set_m_benefit(value);
  // @@protoc_insertion_point(field_set:dgnn_test.MMessageForAD.m_benefit)
}
