 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::dgnn_test::MMessageForAD* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>> AsyncsetM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>>(AsyncsetMRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>> PrepareAsyncsetM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>>(PrepareAsyncsetMRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      virtual void setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, std::function<void(::grpc::Status)>) = 0;
      virtual void setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>* AsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::dgnn_test::MMessageForAD>* PrepareAsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::dgnn_test::MMessageForAD* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>> AsyncsetM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>>(AsyncsetMRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>> PrepareAsyncsetM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>>(PrepareAsyncsetMRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, std::function<void(::grpc::Status)>) override;
      void setM(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>* AsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::dgnn_test::MMessageForAD>* PrepareAsyncsetMRaw(::grpc::ClientContext* context, const ::dgnn_test::MMessageForAD& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_setM_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status setM(::grpc::ServerContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response);
  };
  ...
  template <class BaseClass>
  class WithAsyncMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_setM() {
      ::grpc::Service::MarkMethodAsync(14);
    }
    ~WithAsyncMethod_setM() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status setM(::grpc::ServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestsetM(::grpc::ServerContext* context, ::dgnn_test::MMessageForAD* request, ::grpc::ServerAsyncResponseWriter< ::dgnn_test::MMessageForAD>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(14, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_pullDataFromMasterGeneral<WithAsyncMethod_initParameter<WithAsyncMethod_barrier<WithAsyncMethod_workerPullEmb<WithAsyncMethod_setAndSendG<WithAsyncMethod_sendAccuracy<WithAsyncMethod_freeMaster<WithAsyncMethod_server_PullParams<WithAsyncMethod_server_updateParam<WithAsyncMethod_sendNodes2Wk<WithAsyncMethod_workerPullRmtTrainFeat<WithAsyncMethod_sendInNodes2Wk<WithAsyncMethod_pushEmbs<WithAsyncMethod_aggregateNodes<WithAsyncMethod_setM<Service > > > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_setM() {
      ::grpc::Service::MarkMethodCallback(14,
          new ::grpc::internal::CallbackUnaryHandler< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::dgnn_test::MMessageForAD* request, ::dgnn_test::MMessageForAD* response) { return this->setM(context, request, response); }));}
    void SetMessageAllocatorFor_setM(
        ::grpc::MessageAllocator< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(14);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_setM() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status setM(::grpc::ServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* setM(
      ::grpc::CallbackServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/)  { return nullptr; }
  };
  ...
  template <class BaseClass>
  class WithGenericMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_setM() {
      ::grpc::Service::MarkMethodGeneric(14);
    }
    ~WithGenericMethod_setM() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status setM(::grpc::ServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_setM() {
    ...
    void RequestsetM(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(14, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_setM() {
      ::grpc::Service::MarkMethodRawCallback(14,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->setM(context, request, response); }));
    }
    ~WithRawCallbackMethod_setM() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status setM(::grpc::ServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_setM : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_setM() {
      ::grpc::Service::MarkMethodStreamed(14,
        new ::grpc::internal::StreamedUnaryHandler<
          ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::dgnn_test::MMessageForAD, ::dgnn_test::MMessageForAD>* streamer) {
                       return this->StreamedsetM(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_setM() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status setM(::grpc::ServerContext* /*context*/, const ::dgnn_test::MMessageForAD* /*request*/, ::dgnn_test::MMessageForAD* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedsetM(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::dgnn_test::MMessageForAD,::dgnn_test::MMessageForAD>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_pullDataFromMasterGeneral<WithStreamedUnaryMethod_initParameter<WithStreamedUnaryMethod_barrier<WithStreamedUnaryMethod_workerPullEmb<WithStreamedUnaryMethod_setAndSendG<WithStreamedUnaryMethod_sendAccuracy<WithStreamedUnaryMethod_freeMaster<WithStreamedUnaryMethod_server_PullParams<WithStreamedUnaryMethod_server_updateParam<WithStreamedUnaryMethod_sendNodes2Wk<WithStreamedUnaryMethod_workerPullRmtTrainFeat<WithStreamedUnaryMethod_sendInNodes2Wk<WithStreamedUnaryMethod_pushEmbs<WithStreamedUnaryMethod_aggregateNodes<WithStreamedUnaryMethod_setM<Service > > > > > > > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_pullDataFromMasterGeneral<WithStreamedUnaryMethod_initParameter<WithStreamedUnaryMethod_barrier<WithStreamedUnaryMethod_workerPullEmb<WithStreamedUnaryMethod_setAndSendG<WithStreamedUnaryMethod_sendAccuracy<WithStreamedUnaryMethod_freeMaster<WithStreamedUnaryMethod_server_PullParams<WithStreamedUnaryMethod_server_updateParam<WithStreamedUnaryMethod_sendNodes2Wk<WithStreamedUnaryMethod_workerPullRmtTrainFeat<WithStreamedUnaryMethod_sendInNodes2Wk<WithStreamedUnaryMethod_pushEmbs<WithStreamedUnaryMethod_aggregateNodes<WithStreamedUnaryMethod_setM<Service > > > > > > > > > > > > > > > StreamedService;
};
